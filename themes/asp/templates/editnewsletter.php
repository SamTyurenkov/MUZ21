...
global $post;
wp_nonce_field('_edit_newsletter', '_edit_newsletter');
?>
<div class="editor">
<div class="container">
<div class="editmenu">
 
<span class="pslidercount" onClick="sendNewsletter()">Отправить</span>
<?php 
...
var value = jQuery.ajax({
				...
				success: function(data, textStatus, jqXHR) {
					console.log('newsletter status:'+data.status);
				},
				error: function(jqXHR, textStatus, errorThrown){ 	
					console.log('ajax error in newsletter');
				}
			})
};
...
<?php get_template_part('templates/editnewsletter-options'); ?>
</div>
</div>
</div>
</div>
