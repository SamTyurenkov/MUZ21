...
<?php if ($curuser->ID == $curauth->ID || current_user_can('editor' || 'administrator')) : ?>
<h2 class="homeh2">Настройки аккаунта</h2>
<div class="selector container" id="settings">
<div class="custom-select" id="authortype">
<p>Выберите тип аккаунта</p>
<select>
<option value="empty">Не выбрано</option>
<?php 

$authortypes = get_field_choices('authortype');
