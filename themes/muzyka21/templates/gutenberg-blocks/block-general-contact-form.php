            ...
            <div class="general-contact-form_flex_text">
                ...
                <div class="general-contact-form_flex_text_input_holder">
                    <span class="input_container input_large">
                        ...
                        <input required type="email" placeholder="your@email.domain" value="<?php if(get_current_user_id() > 0) echo esc_attr(get_the_author_meta('email', get_current_user_id())); ?>"></input>
                    </span>
                    <span class="input_container input_large">
                        <label><?php echo esc_html($translations['label_display_name']); ?></label>
                        <input class="general-contact-form_username" required type="text" placeholder="Имя или ник" value="<?php if(get_current_user_id() > 0) echo esc_attr(get_the_author_meta('display_name', get_current_user_id())); ?>"></input>
                    </span>
                    <span class="input_container input_large">
                        <label><?php echo esc_html($translations['label_phone']); ?></label>
                        <input class="general-contact-form_userphone" required type="text" placeholder="+7...." value="<?php if(get_current_user_id() > 0) echo esc_attr(get_the_author_meta('user_phone', get_current_user_id())); ?>"></input>
                    </span>
