        ...
        <div class="places-all-extended_flex">
            ...
            if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post();
                    ...
                    <div class="places-all-extended_flex_el" >
                        <a href="<?php echo esc_attr(get_permalink()); ?>" class="places-all-extended_flex_el_icon" style="background-image:url(<?php echo esc_attr(get_the_post_thumbnail_url(null, 'medium')); ?>)">
