<?php if (is_singular('events') || is_singular('services')) : ?>
    ...
    ?>
    <div id="alfa-payment-button" data-amount='.item_price_option span' data-description-selector='.form_title' data-order-number-selector='.order_id' data-version='1.0' data-stages='1' data-amount-format='rubli' data-email-selector='.form_email' data-client-info-selector='.form_email' data-token='<?php echo esc_attr($payform[1]); ?>' data-language-selector='<?php echo esc_attr(ICL_LANGUAGE_CODE); ?>'></div>
