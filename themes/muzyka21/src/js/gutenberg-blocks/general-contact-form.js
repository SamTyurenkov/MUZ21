...
$(document).ready(function () {
	$('.general-contact-form_flex input[type="submit"]').on("click", function (e) {
		...
		if ($(this).parent().find(".general-contact-form_userphone").val().length < 1 || !ValidatePhone($(this).parent().find(".general-contact-form_userphone").val()))
			$(this).parent().find(".general-contact-form_userphone").addClass("input_invalid");
